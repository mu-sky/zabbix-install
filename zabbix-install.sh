...
#   Thanks: @mu-sky <https://github.com/mu-sky/zabbix-install>    #
#   Intro:  https://github.com/mu-sky/zabbix-install              #
#=================================================================#
echo "#############################################################"
echo "# One click Install zabbix Server                           #"
echo "# Intro: https://github.com/mu-sky/zabbix-install           #"
echo "# Author: @mu-sky <https://github.com/mu-sky/zabbix-install>#"
echo "# Github: https://github.com/mu-sky/zabbix-install          #"
echo "#############################################################"
zabbixdir=`pwd`
